...
//OODT imports
import gov.nasa.jpl.oodt.cas.crawl.typedetection.MetExtractorSpec;
import gov.nasa.jpl.oodt.cas.crawl.typedetection.MimeExtractorConfigReader;
import gov.nasa.jpl.oodt.cas.crawl.typedetection.MimeExtractorRepo;
import gov.nasa.jpl.oodt.cas.filemgr.metadata.CoreMetKeys;
import gov.nasa.jpl.oodt.cas.metadata.MetExtractor;
import gov.nasa.jpl.oodt.cas.metadata.Metadata;
import gov.nasa.jpl.oodt.cas.metadata.preconditions.PreCondEvalUtils;
