...
public interface IngestMapper {
   ...
   * @return True is the catalogServiceTransactionId has been used in a used in
   *         a mapping
   * @throws CatalogRepositoryException
   *           Any error
   */
  ...
  /**
   * Get the Catalog TransactionId that was mapped to the given Catalog ID and
   * CatalogService TransactionId
   * 
   * @param catalogServiceTransactionId
   *          A Catalog TransactionId
   * @param catalogId
