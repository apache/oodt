...
public class SerializedCatalogRepository implements CatalogRepository {
	...
	/*
	 * (non-Javadoc)
	 * @see gov.nasa.jpl.oodt.cas.catalog.repository.MemoryBasedCatalogRepository#deleteSerializedCatalog(java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see gov.nasa.jpl.oodt.cas.catalog.repository.MemoryBasedCatalogRepository#deserializeCatalog(java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see gov.nasa.jpl.oodt.cas.catalog.repository.MemoryBasedCatalogRepository#deserializeAllCatalogs()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see gov.nasa.jpl.oodt.cas.catalog.repository.MemoryBasedCatalogRepository#isCatalogSerialized(java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see gov.nasa.jpl.oodt.cas.catalog.repository.MemoryBasedCatalogRepository#serializeCatalog(gov.nasa.jpl.oodt.cas.catalog.Catalog)
	 */
