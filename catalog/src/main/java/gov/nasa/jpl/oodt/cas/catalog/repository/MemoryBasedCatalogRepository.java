...
public class MemoryBasedCatalogRepository implements CatalogRepository {
	 ...
	 * 
	 * @see
	 * gov.nasa.jpl.oodt.cas.catalog.repository.CatalogRepository#deserializeCatalog
	 * (java.lang.String)
	 */
	 ...
	 * 
	 * @see
	 * gov.nasa.jpl.oodt.cas.catalog.repository.CatalogRepository#serializeCatalog
	 * (gov.nasa.jpl.oodt.cas.catalog.Catalog)
	 */
