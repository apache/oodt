...
import gov.nasa.jpl.oodt.cas.catalog.query.filter.QueryFilter;
import gov.nasa.jpl.oodt.cas.catalog.query.filter.time.conv.AsciiSortableVersionConverter;
import gov.nasa.jpl.oodt.cas.catalog.query.filter.time.conv.VersionConverter;
