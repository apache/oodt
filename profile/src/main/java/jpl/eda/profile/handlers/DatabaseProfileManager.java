...
public abstract class DatabaseProfileManager implements ProfileManager
{
	...
	{
		// load JDBC driver
		String driver = props.getProperty("jpl.eda.util.JDBC_DB.driver","oracle.jdbc.driver.OracleDriver");
		try {
		...
		// get connection
		String url = props.getProperty("jpl.eda.util.JDBC_DB.url", "jdbc:oracle:@");
		String database = props.getProperty("jpl.eda.util.JDBC_DB.database");
		if(database != null) url += database;

                Connection conn = DriverManager.getConnection(url,
                        		props.getProperty("jpl.eda.util.JDBC_DB.user"),
                        		props.getProperty("jpl.eda.util.JDBC_DB.password"));
