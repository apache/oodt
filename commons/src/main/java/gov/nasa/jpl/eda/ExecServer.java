...
//
// $Id: ExecServer.java,v 1.3 2004-04-05 16:24:07 kelly Exp $
...
public class ExecServer {
	...
	public ExecServer(String name, String className) throws ClassNotFoundException, NoSuchMethodException,
		...
		XML.add(startElement, "config", System.getProperty("jpl.eda.Configuration.url", "UNKNOWN"));
	 ...
	 * system properties.  The property name is <code>jpl.eda.initializers</code>, or
	 * if not defined, <code>jpl.eda.ExecServer.initializers</code>, or if not
	...
	public static void runInitializers() throws EDAException {
		String initList = System.getProperty("jpl.eda.initializers",
			System.getProperty("jpl.eda.ExecServer.initializers", System.getProperty("initializers", "")));
		for (Iterator i = jpl.eda.util.Utility.parseCommaList(initList); i.hasNext();) {
	...
	public static final String PRINT_IOR_PROPERTY = "jpl.eda.ExecServer.printIOR";

	/** Name of the property that prevents binding of this object with the naming service. */
	public static final String DISABLE_BINDING = "jpl.eda.ExecServer.disableBinding";

	/** How long to wait before bind attempts, in ms. */
	private static final long REBIND_PERIOD = Long.getLong("jpl.eda.ExecServer.rebindPeriod", 30*60*1000).longValue();
}
