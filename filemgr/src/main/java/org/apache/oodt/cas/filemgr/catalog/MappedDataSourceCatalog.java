...
public class MappedDataSourceCatalog extends DataSourceCatalog {
     ...
     *            name.
     */
    public MappedDataSourceCatalog(String jdbcUrl, String user, String pass, String driver, ValidationLayer valLayer,
            boolean fieldId, int pageSize, long cacheUpdateMin,
            Properties typeMap) {
        super(jdbcUrl, user, pass, driver, valLayer, fieldId, pageSize, cacheUpdateMin);
