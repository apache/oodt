...
public class DirectoryListingServlet extends SSOConfiguredCuratorWebService {

  private static final long serialVersionUID = 7656680180056469412L;
  ...
  public void init(ServletConfig conf) throws ServletException {
    ...
    // this.showFiles = Boolean.valueOf(getInitParameter(DIR_SHOW_FILES_FLAG));
  }
