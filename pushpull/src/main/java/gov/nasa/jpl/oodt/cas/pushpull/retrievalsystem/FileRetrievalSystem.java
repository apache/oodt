...
import gov.nasa.jpl.oodt.cas.pushpull.exceptions.CrawlerException;
...
import gov.nasa.jpl.oodt.cas.pushpull.exceptions.RemoteConnectionException;
...
import gov.nasa.jpl.oodt.cas.pushpull.filerestrictions.renamingconventions.RenamingConvention;
...
import gov.nasa.jpl.oodt.cas.pushpull.protocol.ProtocolHandler;
 ...
 *   	protocolfactory.ftp=&lt;path-to-java-protocolfactory-class&gt; (e.g. gov.nasa.jpl.oodt.cas.protocol.ftp.FtpClientFactory)
 ...
 *   	java.protocol.handler.pkgs=gov.nasa.jpl.oodt.cas.url.handlers
 *    }
 *    
