...
import gov.nasa.jpl.oodt.cas.pushpull.config.DaemonInfo;
import gov.nasa.jpl.oodt.cas.pushpull.config.SiteInfo;
import gov.nasa.jpl.oodt.cas.pushpull.daemon.DaemonMBean;
import gov.nasa.jpl.oodt.cas.pushpull.daemon.DaemonRmiInterface;
import gov.nasa.jpl.oodt.cas.pushpull.protocol.RemoteSite;
import gov.nasa.jpl.oodt.cas.pushpull.retrievalsystem.RetrievalSetup;
    ...
    public Daemon(int rmiRegPort, int daemonID, Config config,
        ...
        try {
            ...
            ObjectName name = new ObjectName(
                    "gov.nasa.jpl.oodt.cas.pushpull.daemon:type=Daemon"
                            + this.getDaemonID());
