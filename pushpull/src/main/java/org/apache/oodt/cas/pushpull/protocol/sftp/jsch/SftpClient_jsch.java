...
package org.apache.oodt.cas.pushpull.protocol.sftp.jsch;
 ...
 * </p>.
 */
public class SftpClient_jsch extends Protocol {
        ...
        try {
            ...
            SftpProgressMonitor monitor = new SftpProgressMonitor() {
                public boolean count(long arg0) {
                    return SftpClient_jsch.this.abort;
                }
        ...
        try {
            ...
            for (ChannelSftp.LsEntry sftpFile : sftpFiles) {
                ...
                returnFiles.add(new ProtocolFile(this.getRemoteSite(),
                        new ProtocolPath(path + "/" + sftpFile.getFilename(),
