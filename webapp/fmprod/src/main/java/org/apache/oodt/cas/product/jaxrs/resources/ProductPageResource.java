...
@XmlType(propOrder = {"pageSize","pageNum","totalPages","numOfHits","metadataResource", "productResources"})
...
public class ProductPageResource
{
    ...
    */
    ...
    /**
     * Constructor that sets the ProductPage, metadata and working directory for the
     ...
     * attach to responses
     */
    public ProductPageResource(ProductPage page, List<Metadata> productMetaDataList, List<List<Reference>> productReferencesList,File workingDir) {
        ...
        for(int i=0;i<pageProducts.size();i++){
            ...
            this.productResources.add(new ProductResource(product,metadata,productReferencesList.get(0),workingDir));
        }
