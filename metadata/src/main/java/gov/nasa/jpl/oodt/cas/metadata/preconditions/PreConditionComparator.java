...
import gov.nasa.jpl.oodt.cas.metadata.exceptions.PreconditionComparatorException;
import static gov.nasa.jpl.oodt.cas.metadata.preconditions.PreConditionOperatorMetKeys.*;
