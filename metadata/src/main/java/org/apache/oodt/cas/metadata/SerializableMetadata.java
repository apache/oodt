...
public class SerializableMetadata extends Metadata implements Serializable {
    ...
    private static Logger LOG = LoggerFactory.getLogger(SerializableMetadata.class);
    ...
    public void writeMetadataToXmlStream(OutputStream os) throws IOException {
        try {
            ...
            String msg = String.format("Error generating metadata xml file: %s", e.getMessage());
            LOG.error(msg, e);
    ...
    public Document toXML() throws IOException {
        try {
            ...
            String msg = String.format("Failed to create XML DOM Document for SerializableMetadata: %s", e.getMessage());
            LOG.error(msg, e);
            throw new IOException(msg, e);
        }
    }
